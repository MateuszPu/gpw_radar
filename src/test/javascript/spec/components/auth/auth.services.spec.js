...
describe('Services Tests ', function () {
    ...
    describe('Auth', function () {
        ...
        beforeEach(inject(function($injector, localStorageService, Auth, AuthServerProvider) {
            ...
            $httpBackend.whenGET('scripts/components/navbars/top/top-navbar.html').respond({});
            $httpBackend.whenGET('scripts/components/navbars/left/left-navbar.html').respond({});
