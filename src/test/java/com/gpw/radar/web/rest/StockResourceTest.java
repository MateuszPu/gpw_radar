...
public class StockResourceTest {
    ...
    private static final GpwStockTicker DEFAULT_Y = GpwStockTicker.wig20;
    private static final GpwStockTicker UPDATED_Y = GpwStockTicker.wig20;
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getY()).isEqualTo(DEFAULT_Y);
    ...
    public void updateStock() throws Exception {
        ...
        Stock testStock = stocks.get(stocks.size() - 1);
        assertThat(testStock.getY()).isEqualTo(UPDATED_Y);
